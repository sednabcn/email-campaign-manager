...
try:
    ...
    class EmailSender(BaseEmailSender):
        ...
        def send_campaign(self, campaign_name, subject, content, recipients, from_name="Campaign System", tracking_id=None):
            """Enhanced campaign sending with template variable substitution and tracking ID"""
...
def generate_tracking_id(domain, campaign_name, template_name):
    """Generate unique tracking ID matching campaign_validator.py format"""
...
def save_tracking_data(tracking_dir, domain, tracking_id, campaign_data):
    """Save campaign tracking data to domain-specific directory"""
...
def campaign_main(contacts_root, scheduled_root, tracking_root, alerts_email, dry_run=False, **kwargs):
    """Main campaign execution function - domain-aware with tracking integration"""
    try:
        ...
        with open(log_file, 'w') as f:
            f.write(f"Domain-Aware Campaign Log\n")
        ...
        for domain, campaign_files in domain_campaigns.items():
            ...
            # Create domain tracking directories
            ...
            for campaign_file in campaign_files:
                ...
                try:
                    ...
                    # Save tracking data to domain-specific directory
                    tracking_data = {
                        'tracking_id': tracking_id,
                        'domain': domain,
                        'campaign_name': campaign_name,
...
if __name__ == "__main__":
    ...
    # Use --templates as alias for --scheduled if provided
